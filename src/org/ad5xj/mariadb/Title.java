...
/**
 * @brief Data definition of Title data object
 * @ingroup MARIADB
 * @author ken
 * @details This is the data bean of the Title data object in the Title table.
 */
@RequestScoped @ManagedBean @Table(name = "Title")
@Entity
public class Title
{
    @GeneratedValue(strategy = GenerationType.IDENTITY) @Column(name = "titleid", nullable = false)
    @Id private int    titleid;
    @Basic
    @Column(name = "authKey", nullable = false)
    private int    authKey;
    @Basic @Column(name = "mediaKey", nullable = false)
    private int    mediaKey;
    @Basic @Column(name = "loanKey")
	private int    loanKey;
    @Basic @Column(name = "title")
    private String title;
    @Basic @Column(name = "bookNote")
    private String bookNote;


    public Title( )
    {
    }  // default constructor no parameters for overload
